	...
	Begin
		Create Database HRdb
			On Primary
				(
					Name = 'HRdb_dat',
					Filename = 'E:\sqlDataBase\HRdb.mdf',
					Size = 5Mb,
					Maxsize = 1000Mb,
					FileGrowth = 1Mb
				),
		FileGroup ArchiveHRdb
			(
					Name = 'HRdb_arh',
					Filename = 'E:\sqlDataBase\HRdb.ndf'				
			)
			Log On
				(
					Name = 'HRdb_log',
					Filename = 'E:\sqlDataBase\HRdb.ldf',
					Size = 3Mb,
					Maxsize = 100Mb,
					FileGrowth = 1Mb					
				)
...
Execute sp_bcp_dbcmptlevel @dbname = 'HRdb';
Go
...
CREATE TABLE countries 
		...
		region_id  INT 
			Foreign key References regions(region_id)
		);
Go	
CREATE UNIQUE INDEX country_id_pk
...
CREATE TABLE job_history
		...
		end_date      DATE,		
		job_id VARCHAR(10)
			Foreign key References jobs(job_id),
		department_id INT 
...
--****************************************
ALTER TABLE departments
  NOCHECK CONSTRAINT FK_dept_mgr;
...
--**********************************************
ALTER TABLE employees
  NOCHECK CONSTRAINT FK_emp_manager;
Go
ALTER INDEX emp_emp_id_pk ON employees  
	DISABLE;  
